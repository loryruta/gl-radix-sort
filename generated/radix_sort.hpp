		...
		{
			{
				...
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_3d7ac1141a4dcdea5e9cbb332550706c);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_02598ff13637371e57b9ea33251b58ea);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_54081c82758fc2b5d9296bbcc1c18860);
				sh.compile();
