		...
		{
			{
				...
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_4fb3cdb5a16e100e7875302390858e6b);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_b1be450fb2717698db42d5f4c4571b1a);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_efdbc9b05a2c4e0d88fe36b3f60c1f38);
				sh.compile();
