		...
		{
			{
				...
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_0d5cce2322f425c3d8251336b867349d);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_37e6c09cfc20da531ba12dffbfb5c878);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_134df495555190898bdd3effd4329bb4);
				sh.compile();
