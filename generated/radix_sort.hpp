		...
		{
			{
				...
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_94c3175869a334fc69f3ec60ab613c34);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_480fbb352791accfe5125b3ae1b3a82c);
				sh.compile();
			...
			{
				shader sh(GL_COMPUTE_SHADER);
				__rgc_shader_injector_load_src(sh.m_name, __rgc_shader_injector_shader_src_2e7514626208dba4b915ec70ecc96b7b);
				sh.compile();
